...
namespace ContatosNet.ContatosDBDataSetTableAdapters {
...
SELECT ContactID, Name, Company, Telephone, Email, Client, LastCall FROM People WHERE (ContactID = @ContactID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ContatosNet.Properties.Settings.Default.ContatosDBConnectionString;
        }
